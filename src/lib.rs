...
#[derive(Debug)]
pub struct ValorStateProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ValorStateProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ValorState processing");
    
    let mut processor = ValorStateProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ValorStateProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ValorStateProcessor::new(false);
